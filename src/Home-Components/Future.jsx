      ...
      >
        <div className='flex flex-col gap-3 items-center justify-center w-full h-full absolute top-0 left-0 '>
          <div className='flex flex-col justify-evenly text-center text-white p-4 bg-black bg-opacity-70 rounded-3xl lg:w-[80%] py-10 border-x-8 border-[#EBCFA7]' data-aos="fade-right">
            ...
            <button className="w-[25%] mx-auto bg-gradient-to-r from-[#ebcfa75c] via-[#26282B] to-black hover:bg-gradient-to-l text-white font-semibold py-2 sm:py-3 px-8 rounded-xl transition duration-300 border-[2px] border-[#ebcfa75c] whitespace-nowrap" data-aos="flip-left" data-aos-delay="300">
